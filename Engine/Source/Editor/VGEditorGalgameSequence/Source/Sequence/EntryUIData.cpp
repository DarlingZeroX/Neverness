...
namespace VisionGal::Editor
{
	...
	SequenceEntryUIDataManager::SequenceEntryUIDataManager()
	{
		...
		GalSeqComDrawerRegistry::GetInstance().RegisterDrawer(MakeRef<GSCD_CommonDialogue>());
		...
		GalSeqComDrawerRegistry::GetInstance().RegisterDrawer(MakeRef<GSCD_ChangeFigure>());
		...
		GalSeqComDrawerRegistry::GetInstance().RegisterDrawer(MakeRef<GSCD_ChangeBackground>());
	}
}
