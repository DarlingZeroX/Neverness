...
public static class Entry
{
	...
	/// <summary>Phase 2：<see cref="BootstrapNativeApi"/> 已成功安裝 <c>NNNativeAPI</c> 並寫入 Log。</summary>
	...
	/// <summary>
	/// Phase 2：接收 Native 傳入之 <c>const NNNativeAPI*</c>（以 <see cref="nint"/> 傳遞），安裝函數表並經 ABI 觸發一次 <c>LogInfo</c>。
	/// </summary>
	/// <param name="nativeApiTable">Native 側 <c>NNNativeApi_GetDefaultTable()</c> 回傳之指標。</param>
	[UnmanagedCallersOnly(CallConvs = new[] { typeof(CallConvStdcall) })]
