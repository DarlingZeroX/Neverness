...
/// <para><b>與 Native 存檔路線之關係</b>：當前僅託管 JSON；未來若在 <b>NNNativeEngineAPI</b> 納入 Gameplay／存檔服務表，可將本 DTO 之 <see cref="ToJson"/> 輸出作為寫入檔案之內容來源，或由 Native 僅負責路徑／slot 與錯誤碼（見總覽 <b>MANAGED_RUNTIME_ARCHITECTURE_AND_PROGRESS.md</b> 之 <c>§5.1</c> 草案）。</para>
/// </remarks>
