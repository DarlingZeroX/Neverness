...
/// </summary>
/// <remarks>
/// <para>Phase 6 slice 3：在纯托管侧把「变量表」与「经 <see cref="T:Neverness.Managed.Scene.SceneRehydrator"/> 恢复的场域实体」放在同一对象中，便于剧本序列编排（不调用 Native <c>NNSceneAPI</c>）。</para>
...
/// </summary>
/// <remarks>
/// 未安装 <c>NNNativeEngineAPI</c> 或未接线 UI 时本步仍返回成功，便于纯托管测试与离线工具链；与 <see cref="DialoguePresenter.PresentLine"/> 的 no-op 行为一致。
/// </remarks>
