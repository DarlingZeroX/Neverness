...
{
	/// <summary>與 Native <c>NN_NATIVE_ENGINE_API_LAYOUT_VERSION</c>（<c>EngineAPIRegistry.h</c>）及託管 <see cref="NNNativeEngineApiConstants.LayoutVersion"/> 一致，當前為 <b>17</b>。</summary>
	[Fact]
