...
public sealed class SceneRehydrationTests : IDisposable
{
	...
	{
		var source = new Neverness.Managed.Scene.SceneEntity(new VGObjectId(1), new NNObjectHandle(1), "SourceName");
		var entry = SceneSerializer.CaptureObject("Entity", source);

		var target = new Neverness.Managed.Scene.SceneEntity(new VGObjectId(2), new NNObjectHandle(2), "Placeholder");
