...
{
    internal static unsafe partial class SystemInterface
    {
        [LibraryImport(ImportConfig.Native_DLL, EntryPoint = "rml_SystemInterface_New")]
        internal static partial IntPtr Create(OnGetElapsedTime onGetElapsedTime, OnTranslateString onTranslateString, OnLogMessage onLogMessage, OnJoinPath onJoinPath, OnSetMouseCursor onSetMouseCursor, OnSetClipboardText onSetClipboardText, OnGetClipboardText onGetClipboardText, OnActivateKeyboard onActivateKeyboard, OnDeactivateKeyboard onDeactivateKeyboard);
