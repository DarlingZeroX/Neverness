...
namespace RmlUiNet.Native {
    ...
    internal static unsafe partial class Plugin {
        [LibraryImport(ImportConfig.Native_DLL, EntryPoint = "rml_Plugin_New")]
        internal static partial IntPtr Create(OnInitialise onInitialise, OnShutdown onShutdown, OnDocumentOpen onDocumentOpen, OnDocumentLoad onDocumentLoad, OnDocumentUnload onDocumentUnload, OnContextCreate onContextCreate, OnContextDestroy onContextDestroy, OnElementCreate onElementCreate, OnElementDestroy onElementDestroy);
