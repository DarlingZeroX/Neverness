...
/// </summary>
/// <remarks>
/// **layout v10**：<c>NNVfsAPI</c> 追加 <c>getAbsolutePath</c>。若僅升 Native 未同步本常數，託管層將無法安裝引擎服務表。
/// </remarks>
public static class NNNativeEngineApiConstants
{
	/// <summary>
	/// 當前 <c>NNNativeEngineAPI</c> 聚合體佈局版本；破壞性子表欄位變更時遞增。當前為 **10**。
	/// </summary>
	public const uint LayoutVersion = 10;
