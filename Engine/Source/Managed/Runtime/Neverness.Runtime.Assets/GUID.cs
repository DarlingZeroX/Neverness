...
public readonly struct GUID : IEquatable<GUID>
{
	...
	/// <summary>自 Native <see cref="NNGuid"/> 轉換。</summary>
	public static GUID FromNative(NNGuid native) => new(native.High, native.Low);

	/// <summary>轉為 Native <see cref="NNGuid"/>。</summary>
	public NNGuid ToNative() => new() { High = High, Low = Low };
