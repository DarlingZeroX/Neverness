...
/// <summary>
/// 音频拖放处理器——从外部拖入音频文件到编辑器。
/// 复制原文件到 Assets/ 并生成 .meta 侧车文件，使用 AudioImporter。
/// </summary>
[DropFileHandler(".wav", ".ogg", ".mp3", ".flac")]
public class AudioDropHandler : IDropFileHandler
{
    private static readonly HashSet<string> SupportedExtensions = new(
        new[] { ".wav", ".ogg", ".mp3", ".flac" },
    ...
    public bool Handle(string filePath, string assetsRoot)
    {
        ...
        var meta = MetaFileManager.GetOrCreateMeta(targetPath, "AudioImporter");
        ...
        EditorAssetDatabase.Register(virtualPath, meta.Guid, AssetTypeId.AudioClip);
