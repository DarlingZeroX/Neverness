...
using Neverness.Editor.ImGuiFrontend.Infrastructure;
...
/// </summary>
public sealed class ImGuiMainWindow : IEditorPanel, IMainWindowHost
{
    // =========================================
    // Fields
    // =========================================
    ...
    public void OnGUI()
    {
        ...
        // 顶层 Window Class
        ImGui.SetNextWindowClass(ref ImGuiDockSpaceProvider.Instance.GetTopLevelWindowClass());
...
#if DEBUG
            Console.WriteLine(
                $"[ImGuiMainWindow] Panel Exception: {panel.GetType().Name}\n{ex}");
#endif
        }
    }
