# NNRuntimeManagedHostLegacy — Legacy CoreCLR 宿主（可选 Native 模块）
...
| **构建选项** | **`VISIONGAL_ENABLE_MANAGED_HOST_LEGACY`**（[Runtime/CMakeLists.txt](../../CMakeLists.txt)），**默认 OFF**；旧选项名转发 |
