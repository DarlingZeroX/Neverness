...
namespace NN::Core::Events {
	...
	//	NN::Core::GlobalEventBus::GetInstance().AppendListener(category,	\
	//	[](const NN::Core::Event* eEvent, const NN::Core::EventDesc eDesc)	\
	//	{	\
...
#define ADD_CLASS_GLOBAL_EVENT_LISTENER(category,callback) \
		NN::Core::Events::GlobalEventBus::AppendGlobalEventListener(category,	\
