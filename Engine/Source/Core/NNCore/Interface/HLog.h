...
#define H_LOG_INFO(...)		NN::Core::HCoreLogger::Info(__VA_ARGS__)
#define H_LOG_WARN(...)		NN::Core::HCoreLogger::Warn(__VA_ARGS__)
#define H_LOG_CRITICAL(...) NN::Core::HCoreLogger::Critical(__VA_ARGS__)
#define H_LOG_ERROR(...)	NN::Core::HCoreLogger::Error(__VA_ARGS__)
