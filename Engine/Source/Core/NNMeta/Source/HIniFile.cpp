...
namespace NN::Core
{
	...
	{
		int SetValue(HSimpleIniA& file, const char* a_pSection, const char* a_pKey, const NN::Core::Meta::Variant& a_bValue,
	...
	Ref<HIniFile> HIniFile::SerializeType(const NN::Core::Meta::Type& type, const META_NAMESPACE::Variant& variant)
	{
