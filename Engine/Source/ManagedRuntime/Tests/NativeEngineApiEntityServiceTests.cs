...
/// <summary>
/// 校驗 Native <b>VGEntityAPI</b> 子表與託管鏡像（MANAGED 總覽 <b>§2.7.1</b>）：<b>layout v5</b>、<c>getServiceAbiToken</c> 與 <c>getRuntimeTick</c>、可選宿主安裝路徑。
/// </summary>
/// <remarks>
/// 與 <see cref="VisionGal.Managed.Entity.EntityWorld"/> 無資料關聯；純 C# ECS 仍僅在 <c>VisionGal.Managed.Entity</c> 程式集內。
...
{
	/// <summary>與 Native <c>VG_NATIVE_ENGINE_API_LAYOUT_VERSION</c>（<c>EngineAPIRegistry.h</c>）及託管 <see cref="VGNativeEngineApiConstants.LayoutVersion"/> 一致，當前為 <b>5</b>。</summary>
	[Fact]
	public void NativeEngineApi_LayoutVersion_Is5()
	{
		Assert.Equal(5u, VGNativeEngineApiConstants.LayoutVersion);
	}
	...
	public unsafe void EntityApi_WhenInstalled_GetServiceAbiToken_ReturnsMagic()
	{
		...
		Assert.Equal(VGNativeEngineApiConstants.EntityServiceAbiToken, token);
