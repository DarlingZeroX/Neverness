...
namespace VisionGal
{
	...
	struct VG_GSS_API VGSSC_CommonDialogue : public TVGSSequenceComponent<VGSSC_CommonDialogue>
	{
	...
	struct VG_GSS_API VGSSC_ChangeFigure : public TVGSSequenceComponent<VGSSC_ChangeFigure>
	{
		VGSSC_ChangeFigure();
	...
	struct VG_GSS_API VGSSC_ChangeBackground : public TVGSSequenceComponent<VGSSC_ChangeBackground>
	{
		...
		struct TempData
		{
			Ref<Texture2D> PreviewTexture = nullptr;
		} Temp;
	};
